...
export const TodoScreen = () => {
    ...
    return (
        <div className="journal_container">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-plus-square-dotted" viewBox="0 0 16 16">
            ...
            <div className="containerTable">
                ...
                {
                    FormStatus &&
                    <Modal  setShowForm={setShowForm} FormStatus={FormStatus} />
                }
            </div>
        </div>
    )
